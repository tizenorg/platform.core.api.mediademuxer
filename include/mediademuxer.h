...
typedef enum {
	...
	MEDIADEMUXER_ERROR_INVALID_URI = TIZEN_ERROR_MEDIA_DEMUXER | 0x02,          		/**< Invalid URI */
 ...
 *          #MEDIADEMUXER_ERROR_INVALID_URI,
 ...
 * @since_tizen 3.0
 * @remarks You must release @a demuxer using mediademuxer_destroy().
 ...
 * @retval #MEDIADEMUXER_ERROR_INVALID_URI Invalid URI
 ...
 * @since_tizen 3.0
 * @remark User should call this before mediademuxer_start API.
 * @param[in] demuxer    The media demuxer handle
 * @return @c 0 on success, otherwise a negative error value
 * @retval #MEDIADEMUXER_ERROR_NONE Successful
 * @retval #MEDIADEMUXER_ERROR_INVALID_PARAMETER Invalid parameter
...
/**
 * @brief Selects the track on which read need to perfomed.
 * @since_tizen 3.0
 * @param[in] demuxer    The media demuxer handle
 ...
 * @since_tizen 3.0
 * @remark User should call this before mediademuxer_read_sample API.
 * @param[in] demuxer    The media demuxer handle
 * @return @c 0 on success, otherwise a negative error value
 * @retval #MEDIADEMUXER_ERROR_NONE Successful
 * @retval #MEDIADEMUXER_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * @param[in,out] format    The media format handle
 * @return @c 0 on success, otherwise a negative error value
 * @retval #MEDIADEMUXER_ERROR_NONE Successful
 * @retval #MEDIADEMUXER_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIADEMUXER_ERROR_INVALID_STATE Invalid state
 ...
 * @param[out] outbuf      Pointer of type media_packet_h
 * @return @c 0 on success, otherwise a negative error value
 * @retval #MEDIADEMUXER_ERROR_NONE Successful
 * @retval #MEDIADEMUXER_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIADEMUXER_ERROR_INVALID_STATE Invalid state
...
/**
 * @brief Unselects the selected tracked read sample can't be performed.
 * @since_tizen 3.0
 * @param[in] demuxer    The media demuxer handle
 * @param[in] track_index      The track index on which is unselect need to performed
 * @return @c 0 on success, otherwise a negative error value
 * @retval #MEDIADEMUXER_ERROR_NONE Successful
 * @retval #MEDIADEMUXER_ERROR_INVALID_PARAMETER Invalid parameter
 * @retval #MEDIADEMUXER_ERROR_INVALID_STATE Invalid state
 ...
 * @since_tizen 3.0
 * @remarks User should call this before mediademuxer_destroy API.
 * @param[in] demuxer    The media demuxer handle
 * @return @c 0 on success, otherwise a negative error value
 * @retval #MEDIADEMUXER_ERROR_NONE Successful
 * @retval #MEDIADEMUXER_ERROR_INVALID_PARAMETER Invalid parameter
